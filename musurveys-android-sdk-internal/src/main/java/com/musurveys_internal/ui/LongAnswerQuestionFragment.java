...
public final class LongAnswerQuestionFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    return inflater.inflate(R.layout.fragment_long_answer_question, container, false);
  }
  ...
  public void onViewCreated(@NonNull View root, @Nullable Bundle savedInstanceState) {
    ...
    QuestionInternal question =
        MuSurveysModule.getInstance().getSurvey(event).getValue().getResult().get().questions.stream()
