...
import com.musurveys_internal.ui.SurveyHostFragment.SurveyHostParent;
 ...
 */
public final class MuSurveysActivity extends AppCompatActivity
  ...
  public static Intent create(Context context, String event) {
    Intent intent = new Intent(context, MuSurveysActivity.class);
